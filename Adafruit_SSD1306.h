...
{
public:
	Adafruit_SSD1306(uint8_t rawHeight = 64, uint8_t rawWidth = 128)
...
public:
	 ...
	 */
	Adafruit_SSD1306_I2c(MicroBitI2C i2c, uint8_t i2cAddress = SSD_I2C_ADDRESS, uint8_t rawHeight = 64, uint8_t rawWidth = 128)
